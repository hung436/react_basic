    ...
    <Container className="bg-light my-4">
      <Row>
        ...
        <div className="col-md-6">
          ...
          <p>
            CÔNG TY CỔ PHẦN BÁCH HÓA XANH
            <br /> Trụ sở chính: 128, Trần Quang Khải, P. Tân Định, Q.1, TP.HCM
            <br />
            Địa chỉ liên hệ: Toà nhà MWG, Lô T2-1.2, Đường D1, Khu Công Nghệ
            Cao, P. Tân Phú, Quận 9, TP. HCM
            <br /> Email:{" "}
            <a href={"https://lienhe@bachhoaxanh.com"}>
              lienhe@bachhoaxanh.com
            </a>
          </p>
